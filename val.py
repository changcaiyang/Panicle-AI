...
def run(data,
    ...
    s = ('%20s' + '%13s' * 7 ) % ('Class', 'Images', 'Labels', 'P', 'R','F1', 'mAP@.5', 'mAP@.5:.95')
    ...
    # Print results
    pf = '%20s' + '%13.4g' * 2 + '%13.4g' * 5  # print format
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/yolov5s.yaml', help='dataset.yaml path')
